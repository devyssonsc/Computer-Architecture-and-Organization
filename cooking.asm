...
.globl main
	...
	#Ler que foi digitado e coloca em texto com tamanho máximo de 60 caracteres
	li $v0, 8
	...
	print_content_complete_row:	#print("+" * (coluna - 1) + txt + "+" * (60 - tam - coluna) + "+")
		...
		print_text:
			lb $a0, 0($s0)
   			...
   			ble $s1, $t2, print_text   	 
			li $t5, 0
			
                 	j print_plus_post_content
				...
				print_plus_post_content:	
					...
					ble $t5, $t6, print_plus_post_content
	...
	print_content_uncomplete_row:	#print("+" + " " * (coluna - 2) + txt + " " * (60 - tam - coluna) + "+")
		...
		li $t5, 0 #zerar coluna
			...
			print_spaces_post_content:	
				...
				ble $t5, $t6, print_spaces_post_content
